  ...
  apply(serverHandler) {
    serverHandler.hooks.beforeHtmlRender.tapPromise(
      ...
      async Application => {
        ...
        head.push(
          <link
            key="dns-precache-demo-cdn"
            rel="preconnect"
            href="https://demo-cdn.reactpwa.com"
          />
        );
        head.push(
          <link
            key="dns-precache-codefund"
            rel="preconnect"
            href="https://codefund.app"
          />
        );
        head.push(
          <link
            key="dns-precache-google-analytics"
            rel="preconnect"
        ...
        head.push(
          <link
            key="dns-precache-googletagmanager"
            rel="preconnect"
      ...
      async Application => {
        Application.htmlProps.footer.push(
          <script
            ...
            src="https://www.googletagmanager.com/gtag/js?id=UA-108804791-2"
          />
        );
        Application.htmlProps.footer.push(
          <script
